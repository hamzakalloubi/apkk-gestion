              ...
              <div class="col-sm-8 ">
                  ...
                  <div class="card">
                      ...
                      <div class="card-body" style="padding-bottom: 0;">
                          ...
                          <hr>
                          <form   action="{{route('demandes.store')}}" method="POST" novalidate="novalidate">
                            @csrf
                            <div class="row">
                              <div class="col-6">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-6">
                                    <label >Anneé scolarité :
                                      <input style="margin-left: 1px; " type="datetime" name="Anneé_scolarité" class="form-control" id="" placeholder="date">
                                      <small id="" class="form-text text-muted"></small>
                                      </div>
